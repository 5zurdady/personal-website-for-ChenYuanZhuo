...
export default function ScoreGuide() {
  ...
  return (
    <aside className="relative shrink-0 text-[10px] leading-5 text-neutral-400">
      ...
      <div
        className={`absolute left-[calc(100%+1.25rem)] top-full z-10 -mt-12 grid w-[30rem] grid-cols-1 gap-x-6 overflow-hidden transition-all duration-500 ease-out sm:grid-cols-2 ${
